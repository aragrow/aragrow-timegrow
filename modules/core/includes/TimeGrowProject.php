...
class TimeGrowProject{
   ...
   //     add_action('wp_ajax_delete_expense', array($this, 'delete_ajax')); // Add delete action
    ...
    public function enqueue_scripts_styles() {
        ...
        wp_enqueue_style('timegrow-projects-style', TIMEGROW_CORE_BASE_URI . 'assets/css/project.css');
        wp_enqueue_script('timegrow-projects-script', TIMEGROW_CORE_BASE_URI . 'assets/js/project.js', array('jquery'), '1.0', true);
        wp_localize_script(
